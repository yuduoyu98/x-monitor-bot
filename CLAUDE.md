...
> **进度**:SP1 全完成(契约 + ScweetSource ✅ + NitterSource ✅)、SP2 全完成、SP3 Sink ✅。42 单测 + 3 live。每订阅可配 `sync_mode`/`poll_interval`/`fetch_limit`/`skip_retweets`。待办:旧代码清理(SP1-d)、admin_gui 重构(SP4)。
